...
export default function ProfileManagementPage() {
  return (
    <div className="flex-1 px-12 py-10">
      ...
      <div className="relative bg-white border border-[#787878] rounded-xs shadow-sm overflow-visible">
        
        <div className="absolute -top-4 right-12 flex flex-col items-center z-20">
          <div className="bg-[#299BFF] text-white text-font text-[11px] font-bold px-4 py-1.5 rounded-xs shadow-md font-inter">
        ...
        <div className="p-10 flex items-center min-h-[220px]">
          ...
          <div className="flex items-center border-l border-gray-100 pl-4 h-32 shrink-0">
